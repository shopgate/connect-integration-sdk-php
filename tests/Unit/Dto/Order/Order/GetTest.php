...
class GetTest extends TestCase
{
    public function testBasicProperties()
    {
        ...
        $this->assertEquals($expectedFulfillmentGroup['fulfillmentMethod'],
            $actualFulfillmentGroup->getFulfillmentMethod());
        $this->assertEquals($expectedFulfillmentGroup['fulfillmentLocationCode'],
            $actualFulfillmentGroup->getFulfillmentLocationCode());
        $this->assertEquals($expectedFulfillmentGroup['shipToAddressSequenceIndex'],
        ...
        $this->assertInstanceOf(OrderDto\FulfillmentGroup\Fulfillment\FulfillmentPackage::class,
        ...
        $this->assertEquals($expectedFulfillmentPackage['fulfilledFromLocationCode'],
        ...
        $this->assertEquals($expectedFulfillmentPackage['fulfilledDate'],
        ...
        $this->assertInstanceOf(OrderDto\FulfillmentGroup\Fulfillment\FulfillmentPackage\PackageItem::class,
            $actualPackageItems);
        ...
        $this->assertEquals($expectedLineItem['fulfillmentLocationCode'],
            $actualLineItem->getFulfillmentLocationCode());
        $this->assertEquals($expectedLineItem['shipToAddressSequenceIndex'],
        ...
        $this->assertEquals($expectedLineItem['product']['currencyCode'],
