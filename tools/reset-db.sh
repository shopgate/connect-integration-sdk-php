...
docker-compose ${DOCKER_COMPOSE_PARAMETERS} stop omni-customer catalog import import-script orrder && docker-compose ${DOCKER_COMPOSE_PARAMETERS} up -d omni-customer catalog import import-script order
